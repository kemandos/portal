...
export const Header: React.FC<HeaderProps> = ({ viewState, setViewState, onOpenSettings, isDesktop = true }) => {
  ...
  return (
    <header className="sticky top-0 z-40 px-3 py-2 md:px-6 md:py-4 transition-all w-full pointer-events-none">
        ...
        <div className="pointer-events-auto max-w-[1920px] 3xl:max-w-none mx-auto bg-[#FDFBF7]/60 backdrop-blur-xl border border-white/40 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] px-3 py-2 md:px-4 md:py-2 3xl:px-6 3xl:py-3">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
              ...
              <div className="flex items-center justify-between w-full md:w-auto gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="size-8 md:size-9 bg-gradient-to-br from-white/80 to-white/20 rounded-xl flex items-center justify-center text-primary shadow-lg shadow-primary/10 ring-1 ring-white/60 3xl:size-11">
                      <Users size={18} className="3xl:w-6 3xl:h-6" />
                    </div>
                    <h1 className="text-lg font-bold tracking-tight hidden md:block text-slate-900/90 drop-shadow-sm 3xl:text-2xl">Staffing</h1>
                  </div>
              ...
              <div className="hidden md:flex items-center gap-2 justify-end">
                  ...
                  <div className="flex items-center gap-1">
                      <button 
                          onClick={onOpenSettings}
                          className="size-9 flex items-center justify-center rounded-xl text-slate-600 hover:text-primary transition-all duration-300 hover:bg-white/60 hover:shadow-glow hover:scale-110 active:scale-95 border border-transparent hover:border-white/50 3xl:size-11"
                      >
